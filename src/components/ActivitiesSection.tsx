...
export default function ActivitiesSection({ weather, activities }: { weather: WeatherResponse, activities: ActivitiesResponse }) {
    ...
    return (
        <section className="col-span-full max-md:pb-12 md:py-7.5 md:col-span-6 lg:col-span-5 md:col-start-7 lg:col-start-8 py-5 gap-y-7.5 md:gap-y-12.5 max-md:px-5 flex flex-col bg-white text-black max-md:order-last md:pr-8 lg:pr-16 xl:pr-20 2xl:pr-32 row-span-3">
