...
export default function ActivityCard({ activity, suitable }: { activity: ActivitiesResponse["activities"][0], suitable: boolean }) {
    ...
    return (
        <>
            ...
            >
                {mainImageUrl && (
                    <figure className="w-full relative max-md:h-32.5 md:h-full md:col-span-2 lg:col-span-1">
                ...
                <div className="flex flex-col max-md:gap-y-1.2 md:col-span-3 md:col-start-3 lg:col-span-4 lg:col-start-2 border-b border-secondary-50 pb-5 md:pb-6">
