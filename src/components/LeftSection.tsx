...
export default function LeftSection() {
    ...
    return (
        <section className="col-span-full md:col-span-6 pt-5 max-md:pb-5 sm:min-h-240 md::min-h-200 content-baseline max-md:px-5 grid grid-cols-6 flex-col bg-purple text-white row-span-1 md:pl-8 lg:pl-16 xl:pl-32">
            ...
            <div className={cn("grid auto-rows-max col-span-full md:col-span-5 transition-[grid_rows] duration-300 gap-y-7.5 font-light",
                {
