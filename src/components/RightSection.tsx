...
export default function RightSection({ weather, activities }: { weather: WeatherResponse, activities: ActivitiesResponse }) {
    ...
    return (
        <section className="col-span-full max-md:pb-12 md:pt-7.5 md:col-span-6 md:col-start-8 py-5 gap-y-7.5 md:gap-y-12.5 max-md:px-5 flex flex-col bg-white text-black max-md:order-last md:pr-8 lg:pr-16 xl:pr-32 row-span-2">
